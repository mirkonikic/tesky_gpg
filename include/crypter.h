...
class Crypter{
  public:
    int n_pubkey;           //number of nodes in pubkey linked list
    int n_privkey;           //number of nodes in privkey linked list
    pubkey *pub_head_node;       //beginning of the pubkey linked list
    privkey *priv_head_node;     //beginning of the privkey linked list
    pubkey *pub_curr_key;        //holds selected public key
    privkey *priv_curr_key;      //holds selected private key
    ...
    gpgme_ctx_t tesky_ctx;    //configuration, status and result 
    int tesky_armored;
    ...
    gpgme_protocol_t tesky_protocol;   //default protocol is OpenPGP
...
//    ~Crypter();
  ...
  private:
    std::string tesky_ctx_get_protocol();
  protected:
